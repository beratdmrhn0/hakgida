      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/#contact" className="hover:text-white transition-colors duration-200">İletişim</Link></li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center text-sm">
          <p>
            ...
            {' | '}
            <Link to="/kalite-politikamiz" className="hover:text-white transition-colors duration-200">Kalite Politikası</Link>
            {' | '}
            <Link to="/kvkk-metni" className="hover:text-white transition-colors duration-200">KVKK Metni</Link>
          </p>
        </div>
      </div>
    </footer>
